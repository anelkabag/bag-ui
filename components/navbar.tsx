...
const NavLink = ({
    ...
    >
        {label}
        {external && <sup className="text-[10px] text-gray-400 leading-none">↗</sup>}
        ...
        <>
            ...
            >
                <nav className="flex items-center justify-between px-8 h-14 bg-white ">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        >
                            <Link href="/login" className="h-9 px-4 rounded-full text-sm font-medium text-black border border-gray-300 hover:bg-gray-100 hover:border-gray-400 transition-all inline-flex items-center justify-center">
                                Login
                            </Link>
                            <Link href="/access" className="h-9 px-4 rounded-full text-sm font-medium text-white bg-black border border-black hover:bg-gray-800 transition-all inline-flex items-center justify-center">
                                Get access
                            </Link>
                        </motion.div>
                        <button
            ...
            >
                ...
                >
                    ...
                    <Sep />
                    <div className="flex items-center gap-2">
                        <Link href="/login" className="hidden sm:inline-flex h-8 px-4 rounded-full text-[13px] font-medium text-black border border-gray-300 hover:bg-gray-100 hover:border-gray-400 transition-all items-center justify-center">
                            Login
                        </Link>
                        <Link href="/access" className="inline-flex h-8 px-4 rounded-full text-[13px] font-medium text-white bg-black border border-black hover:bg-gray-800 transition-all items-center justify-center">
                            Get access
                        </Link>
                        <button
                            className="md:hidden p-2 text-black"
            ...
            >
                ...
                >
                    <Link href="/login" onClick={() => setMobileOpen(false)} className="w-full py-4 rounded-xl border border-gray-300 text-black text-[14px] font-bold flex items-center justify-center hover:bg-gray-50 transition-colors">
                        Login
                    </Link>
                    <Link href="/access" onClick={() => setMobileOpen(false)} className="w-full py-4 rounded-xl bg-black text-white text-[14px] font-bold flex items-center justify-center hover:bg-gray-800 transition-colors">
                        Get access
                    </Link>
                </motion.div>
            </motion.div>
