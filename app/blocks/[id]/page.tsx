...
const PKG_ICONS: Record<PkgManager, React.ReactNode> = {
  ...
  bun: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="text-gray-800">
        <circle cx="12" cy="12" r="9" />
        <path d="M8 12c0-2.2 1.8-4 4-4s4 1.8 4 4" stroke="white" strokeWidth="1.5" fill="none" />
      </svg>
  ),
};
  ...
  return (
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Refresh icon */}
          <button className="p-2 hover:bg-gray-200 rounded-lg transition-colors" title="Refresh">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-gray-600">
        ...
        <div className="flex items-center gap-2 ml-auto">
          ...
          <div className="relative">
            ...
            >
              <svg width="16" height="16" viewBox="0 0 12 12" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-gray-600">
                  ...
                  >
                    {PKG_MANAGERS.map((p) => (
                        ...
                        >
                          ...
                          <span>{p}</span>
                          {pkg === p && (
                              <svg width="12" height="12" viewBox="0 0 12 12" fill="currentColor" className="ml-auto text-gray-600">
                                <path d="M10 3l-6 6-3-3" stroke="currentColor" fill="none" strokeWidth="2" />
                              </svg>
                          )}
                        </button>
                    ))}
          ...
          {/* Share button */}
          <button className="p-2 hover:bg-gray-200 rounded-lg transition-colors text-gray-600" title="Share">
