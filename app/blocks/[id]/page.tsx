...
function CodeBlock({ code }: { code: string }) {
  ...
  return (
    <div className="relative rounded-xl border border-gray-200 bg-gray-950 overflow-hidden">
      <div className="flex items-center justify-between px-2.5 sm:px-4 py-2 sm:py-2.5 border-b border-white/10 gap-2">
        ...
        <button
          ...
          className="text-[10px] sm:text-xs text-gray-400 hover:text-white transition-colors flex items-center gap-1 sm:gap-1.5 flex-shrink-0"
        >
      ...
      <pre className="p-2.5 sm:p-5 overflow-x-auto">
        <code className="text-gray-300 font-mono text-[11px] sm:text-[13px] leading-relaxed">
          {code}
        </code>
      </pre>
    </div>
...
function IframePreview({
  ...
  return (
    ...
    >
      ...
      />
      {blurred && (
        <div className="absolute inset-0 backdrop-blur-sm bg-white/70 flex flex-col items-center justify-center gap-2 sm:gap-3 px-3">
          <div className="flex items-center gap-1.5 sm:gap-2 bg-white rounded-full px-2.5 sm:px-4 py-1.5 sm:py-2 shadow-sm border border-gray-200">
            <svg
              width="12"
              height="12"
              viewBox="0 0 14 14"
          ...
          <Link
            href="/access"
            className="h-7 sm:h-8 px-4 sm:px-5 rounded-full text-[11px] sm:text-xs font-medium text-white bg-black hover:bg-gray-800 transition-all inline-flex items-center"
          >
            Get access →
          </Link>
        </div>
...
function VariantToolbarHeader({
  ...
  return (
    <motion.div
      ...
      className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between mb-4 pb-3 border-b border-gray-200 -mx-4 sm:-mx-6 px-4 sm:px-6 py-2 sm:py-3"
    >
      {/* Left: Tabs + Icons */}
      <div className="flex items-center gap-2 sm:gap-3 overflow-x-auto">
        ...
        <div className="flex items-center gap-1 bg-white border border-gray-200 rounded-lg p-1 flex-shrink-0">
          {(["preview", "code"] as ViewMode[]).map((m) => (
            <button
              key={m}
              onClick={() => setMode(m)}
              className={`flex items-center gap-0.5 sm:gap-1.5 px-2 sm:px-3 py-1 sm:py-1.5 rounded-md text-[11px] sm:text-xs font-medium transition-all cursor-pointer ${
                mode === m
        ...
        {/* Fullscreen icon */}
        <button
          className="p-1 sm:p-2 hover:bg-gray-200 rounded-lg transition-colors cursor-pointer flex-shrink-0"
          title="Fullscreen"
        >
          <svg
            width="14"
      ...
      <div className="flex items-center gap-1 sm:gap-2 ml-0 sm:ml-auto overflow-x-auto">
        {/* CLI Command Display */}
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1.5 sm:gap-2 mb-2 flex-wrap">
        ...
        <span
          className={`inline-flex items-center px-1.5 sm:px-2 py-0.5 rounded-full text-[9px] sm:text-[10px] font-bold tracking-wide flex-shrink-0 ${
            variant.pro
...
export default function BlockDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-6 sm:pt-10 pb-12 sm:pb-20">
        {/* Breadcrumb */}
        <div className="flex items-center gap-1.5 text-[11px] sm:text-xs text-gray-400 mb-4 sm:mb-8 truncate">
          <Link
            href="/blocks"
          ...
          <div className="flex items-start justify-between gap-3 sm:gap-6 flex-wrap">
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-1.5 sm:gap-2.5 mb-2 flex-wrap">
                ...
                {block.new && (
                  <span className="inline-flex items-center px-2 sm:px-2.5 py-0.5 rounded-full text-[10px] sm:text-xs font-semibold bg-black text-white flex-shrink-0">
                    New
                  </span>
                )}
              </div>
        ...
        <div className="border-t border-gray-100 mb-6 sm:mb-10" />
