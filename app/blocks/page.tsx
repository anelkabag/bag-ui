...
export function BlockPreview({ id }: { id: string }) {
    const previews: Record<string, React.ReactNode> = {
            ...
            <svg viewBox="0 0 320 180" xmlns="http://www.w3.org/2000/svg">
                ...
                {[0,1,2,3,4].map(i=>(
                    <g key={i} transform={`translate(24, ${36+i*28})`}>
                        ...
                        <rect x={i===1?10:248} y={i===1?16:8} width={i===1?180:16} height={i===1?4:5} rx="2" fill="#9ca3af"/>
                    </g>
                ))}
            </svg>
        ),
            ...
            <svg viewBox="0 0 320 180" xmlns="http://www.w3.org/2000/svg">
                ...
                {[0,1,2,3].map(i=>(
                    <g key={i} transform={`translate(${16+i*76}, 44)`}>
                        <rect width="68" height="116" rx="8" fill="#fff" stroke="#e5e7eb" strokeWidth="1"/>
        ...
        contact: (
            <svg viewBox="0 0 320 180" xmlns="http://www.w3.org/2000/svg">
                <rect width="320" height="180" fill="#f9fafb"/>
                <rect x="16" y="16" width="132" height="148" rx="8" fill="#fff" stroke="#e5e7eb" strokeWidth="1"/>
                ...
                {[0,1,2].map(i=>(
                    <g key={i} transform={`translate(28, ${66+i*22})`}>
                        ...
                        <rect y="9" width="108" height="12" rx="4" fill="#f3f4f6" stroke="#e5e7eb" strokeWidth="1"/>
                    </g>
                ))}
        ...
        gallery: (
            <svg viewBox="0 0 320 180" xmlns="http://www.w3.org/2000/svg">
                ...
                {[0,1,2,3,4,5].map(i=>(
                    <rect key={i} x={16+(i%3)*102} y={36+Math.floor(i/3)*72} width="94" height="64" rx="6" fill="#e5e7eb"/>
                ))}
            </svg>
        ),
        logos: (
            <svg viewBox="0 0 320 180" xmlns="http://www.w3.org/2000/svg">
                ...
                {[0,1,2,3,4].map(i=>(
                    <rect key={i} x={16+i*60} y="56" width="48" height="28" rx="4" fill="#e5e7eb"/>
                ))}
                <rect x="96" y="110" width="128" height="8" rx="3" fill="#9ca3af"/>
                {[0,1,2,3,4].map(i=>(
                    <rect key={i} x={16+i*60} y="132" width="48" height="28" rx="4" fill="#e5e7eb"/>
                ))}
            </svg>
        ),
        banner: (
            <svg viewBox="0 0 320 180" xmlns="http://www.w3.org/2000/svg">
                ...
                {[0,1,2].map(i=>(
                    <g key={i} transform={`translate(0, ${20+i*52})`}>
                        <rect x="12" width="296" height="40" rx="8" fill={i===0?"#111827":i===1?"#fef3c7":"#fff"} stroke={i===2?"#e5e7eb":"none"} strokeWidth="1"/>
                        <rect x="24" y="15" width="96" height="6" rx="2" fill={i===0?"#fff":"#374151"}/>
                        <rect x="200" y="13" width="60" height="12" rx="6" fill={i===0?"#fff":"#111827"}/>
                    </g>
                ))}
            </svg>
        ),
        signup: (
            <svg viewBox="0 0 320 180" xmlns="http://www.w3.org/2000/svg">
                <rect width="320" height="180" fill="#f9fafb"/>
                <rect x="80" y="12" width="160" height="156" rx="10" fill="#fff" stroke="#e5e7eb" strokeWidth="1"/>
                ...
                {["Email","Password"].map((f,i)=>(
                    <g key={f} transform={`translate(96, ${60+i*30})`}>
                        ...
                        <rect y="9" width="128" height="16" rx="5" fill="#f3f4f6" stroke="#e5e7eb" strokeWidth="1"/>
                    </g>
                ))}
        ...
        sidebar: (
            <svg viewBox="0 0 320 180" xmlns="http://www.w3.org/2000/svg">
                ...
                {[0,1,2,3,4,5].map(i=>(
                    <g key={i}>
                        <rect x="8" y={44+i*16} width="4" height="4" rx="1" fill={i===0?"#374151":"#9ca3af"}/>
                        <rect x="16" y={45+i*16} width={32-i*2} height="4" rx="2" fill={i===0?"#374151":"#9ca3af"}/>
                    </g>
                ))}
        ...
        "data-table": (
            <svg viewBox="0 0 320 180" xmlns="http://www.w3.org/2000/svg">
                <rect width="320" height="180" fill="#f9fafb"/>
                <rect x="16" y="16" width="288" height="148" rx="8" fill="#fff" stroke="#e5e7eb" strokeWidth="1"/>
                <rect x="16" y="16" width="288" height="28" rx="8" fill="#f9fafb" stroke="#e5e7eb" strokeWidth="1"/>
                {["Name","Status","Role","Date"].map((h,i)=>(
                    <rect key={h} x={28+i*70} y="26" width={40+i*2} height="6" rx="2" fill="#374151"/>
                ))}
                {[0,1,2,3,4,5].map(row=>(
                    <g key={row} transform={`translate(0, ${44+row*18})`}>
                        <rect x="16" width="288" height="18" fill={row%2===0?"#fff":"#f9fafb"} stroke="#e5e7eb" strokeWidth="0.5"/>
                        {[0,1,2,3].map(col=>(
                            <rect key={col} x={28+col*70} y="6" width={col===0?48:col===1?32:col===2?40:28} height="5" rx="2" fill="#9ca3af"/>
                        ))}
                    </g>
                ))}
            </svg>
        ...
        settings: (
            <svg viewBox="0 0 320 180" xmlns="http://www.w3.org/2000/svg">
                <rect width="320" height="180" fill="#f9fafb"/>
                <rect x="16" y="16" width="80" height="148" rx="6" fill="#fff" stroke="#e5e7eb" strokeWidth="1"/>
                {["General","Profile","Security","Billing","Notifs"].map((s,i)=>(
                    <g key={s} transform={`translate(16, ${16+i*28})`}>
                        <rect width="80" height="26" rx="6" fill={i===0?"#f3f4f6":"transparent"}/>
                        <rect x="12" y="10" width={36+i*2} height="5" rx="2" fill={i===0?"#111827":"#9ca3af"}/>
                    </g>
                ))}
                <rect x="108" y="16" width="196" height="148" rx="6" fill="#fff" stroke="#e5e7eb" strokeWidth="1"/>
                ...
                {[0,1,2,3].map(i=>(
                    <g key={i} transform={`translate(120, ${48+i*26})`}>
                        ...
                        <rect y="9" width="168" height="12" rx="4" fill="#f3f4f6" stroke="#e5e7eb" strokeWidth="1"/>
                    </g>
                ))}
        ...
        "user-profile": (
            <svg viewBox="0 0 320 180" xmlns="http://www.w3.org/2000/svg">
                ...
                <circle cx="72" cy="84" r="28" fill="#e5e7eb" stroke="#fff" strokeWidth="3"/>
                ...
                {[0,1,2].map(i=>(
                    <g key={i} transform={`translate(${80+i*72}, 130)`}>
                        <rect width="64" height="24" rx="4" fill="#f3f4f6" stroke="#e5e7eb" strokeWidth="1"/>
        ...
        onboarding: (
            <svg viewBox="0 0 320 180" xmlns="http://www.w3.org/2000/svg">
                <rect width="320" height="180" fill="#f9fafb"/>
                <rect x="60" y="12" width="200" height="156" rx="10" fill="#fff" stroke="#e5e7eb" strokeWidth="1"/>
                ...
                <rect x="80" y="68" width="160" height="16" rx="5" fill="#f3f4f6" stroke="#e5e7eb" strokeWidth="1"/>
                <rect x="80" y="92" width="40" height="4" rx="2" fill="#374151"/>
                <rect x="80" y="100" width="160" height="16" rx="5" fill="#f3f4f6" stroke="#e5e7eb" strokeWidth="1"/>
        ...
        "todo-list": (
            <svg viewBox="0 0 320 180" xmlns="http://www.w3.org/2000/svg">
                <rect width="320" height="180" fill="#f9fafb"/>
                <rect x="40" y="16" width="240" height="148" rx="8" fill="#fff" stroke="#e5e7eb" strokeWidth="1"/>
                ...
                {[0,1,2,3,4,5].map(i=>(
                    <g key={i} transform={`translate(56, ${50+i*18})`}>
                        <rect width="12" height="12" rx="3" fill={i<3?"#111827":"#f3f4f6"} stroke={i<3?"none":"#d1d5db"} strokeWidth="1"/>
                        <rect x="20" y="3" width={100+i*8} height="5" rx="2" fill={i<3?"#d1d5db":"#374151"}/>
                    </g>
                ))}
            </svg>
        ),
        ...
        "product-detail": (
            <svg viewBox="0 0 320 180" xmlns="http://www.w3.org/2000/svg">
                ...
                {[0,1,2,3].map(i=>(
                    <rect key={i} x={12+i*34} y="140" width="28" height="20" rx="4" fill={i===0?"#e5e7eb":"#d1d5db"} stroke={i===0?"#374151":"none"} strokeWidth="1"/>
                ))}
                <rect x="160" y="16" width="148" height="148" rx="0" fill="transparent"/>
                ...
                <rect x="160" y="146" width="140" height="14" rx="7" fill="none" stroke="#d1d5db" strokeWidth="1.5"/>
            </svg>
        ),
        "shopping-cart": (
            <svg viewBox="0 0 320 180" xmlns="http://www.w3.org/2000/svg">
                ...
                <rect x="196" y="16" width="108" height="148" rx="8" fill="#fff" stroke="#e5e7eb" strokeWidth="1"/>
                ...
                <rect x="28" y="160" width="152" height="0" rx="0" fill="none"/>
            ...
            <svg viewBox="0 0 320 180" xmlns="http://www.w3.org/2000/svg">
                ...
                {[0,1,2,3].map(i=>(
                    <g key={i} transform={`translate(28, ${50+i*30})`}>
                        ...
                        {[0,1,2,3,4].map(s=><rect key={s} x={88+s*12} y="5" width="8" height="4" rx="1" fill={s<4?"#fbbf24":"#e5e7eb"}/>)}
            ...
            <svg viewBox="0 0 320 180" xmlns="http://www.w3.org/2000/svg">
                ...
                {[0,1,2].map(i=>(
                    <g key={i} transform={`translate(${16+i*102}, 20)`}>
                        <rect width="92" height="144" rx="8" fill="#fff" stroke="#e5e7eb" strokeWidth="1"/>
...
function BlockCard({ id, label, count, pro, new: isNew }: {
    ...
    return (
        <Link href={`/blocks/${id}`} className="group block">
            ...
            <div className="relative overflow-hidden rounded-xl border border-gray-200 bg-gray-50 aspect-[16/9] mb-3 transition-all duration-200 group-hover:border-gray-400 group-hover:shadow-md flex items-center justify-center">
        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="max-w-7xl mx-auto px-6 pt-10 pb-20">
                    ...
                    {filters.map((f) => (
                        <button
                            ...
                            className={`relative flex items-center gap-1.5 px-4 py-2.5 text-sm font-medium transition-colors ${
                                activeFilter === f.key ? "text-black" : "text-gray-500 hover:text-gray-800"
                            }`}
                        >
                            {f.label}
                ...
                <div className="flex flex-wrap items-center gap-x-3 gap-y-1 py-4 text-sm text-gray-400 mb-4">
                    {showMarketing && <a href="#marketing" className="hover:text-black transition-colors">Marketing</a>}
                    {showMarketing && (showApp || showEcommerce) && <span>/</span>}
                    {showApp && <a href="#app" className="hover:text-black transition-colors">App</a>}
                    {showApp && showEcommerce && <span>/</span>}
                    {showEcommerce && <a href="#ecommerce" className="hover:text-black transition-colors">Ecommerce</a>}
                </div>
